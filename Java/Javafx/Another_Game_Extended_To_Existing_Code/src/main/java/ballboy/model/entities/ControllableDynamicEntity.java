...
public class ControllableDynamicEntity<T extends DynamicEntity> extends DynamicEntity {
    ...
    public ControllableDynamicEntity(
     ...
     private ControllableDynamicEntity(
            T entity,
            Vector2D startingPosition,
            double maxHorizontalVelocity,
            double floorHeight,
            double gravity,
            Optional<Runnable> afterNextBounce) {
        this.entity = entity;
        this.maxHorizontalVelocity = Math.abs(maxHorizontalVelocity);
        this.floorHeight = Math.abs(floorHeight);
        this.gravity = gravity;
        this.startingPosition = startingPosition;
        this.afterNextBounce = afterNextBounce;
    }
    ...
    public ControllableDynamicEntity<T> copy(Level level) {
        return new ControllableDynamicEntity<T>((T) this.entity.copy(level),this.startingPosition.copy(),this.maxHorizontalVelocity,this.floorHeight,this.gravity,this.afterNextBounce);
    }
